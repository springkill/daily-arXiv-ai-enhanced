...
<div align="center">
<img src="images/ui-language.png" width="72%" alt="首次进入选择语言">
</div>

第一次打开会让你选语言，之后记住。随时可以在 **设置 → 语言** 里改。这个选择影响三处，
但生效方式不一样：
...
只有总结没法追溯改——它是流水线抓取当天就写好的。如果你选的语言在当前日期范围内
没有对应的总结，页面会直接说明，并告诉你去改 `.env.local` 里的 `LANGUAGE`。
已经生成的审稿意见按当时的语言保留，不会重新翻译。
